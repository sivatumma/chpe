...
(function(chUtils) {
  ...
  chUtils.setDefaultDate = function(data) {
  ...
  "July", "August", "September", "October", "November", "December"
    ...
    var year = data.schemeDetails[0].behavior.startDate.toISOString().substring(0, 4);
    var month = data.schemeDetails[0].behavior.startDate.toISOString().substring(5, 7);
...
_.each(data.orderDetails.revenues_and_discounts.revenues,function(item,key){

revenues[key] = item;
})
_.each(data.orderDetails.revenues_and_discounts.discounts,function(item,key){

discounts[key] = item;
})

data.orderDetails.revenues_and_discounts.discounts = discounts;
data.orderDetails.revenues_and_discounts.revenues =  revenues;
return data;
...
revenues_and_discounts =  { revenues : revenues , discounts:discounts};
    ...
    finalData.revenues_and_discounts = revenues_and_discounts;
return finalData;
    };
