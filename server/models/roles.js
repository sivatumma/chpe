...
module.exports = function (mongoose) {
    ...
    rolesSchema.virtual('isLocked').get(function() {
    ...
    rolesSchema.methods.comparePassword = function(candidatePassword, cb) {
    ...
    rolesSchema.methods.incLoginAttempts = function(cb) {
    ...
    var reasons = rolesSchema.statics.failedLogin = {
        NOT_FOUND: 0,
    ...
    rolesSchema.statics.getAuthenticated = function(username, password, cb) {
    ...
    rolesSchema.statics.authorize = function(req,res, next) {
